...
@pytest.mark.parametrize("input_list_of_transactions, input_transaction_state, return_list_of_transactions", [
    ...
    ([{'id': 41428829, 'state': 'EXECUTED', 'date': '2019-07-03T18:35:29.512364'}, {'id': 939719570, 'state': 'EXECUTED', 'date': '2018-06-30T02:08:58.425572'}], "CANCELED", [])
])
def test_filter_by_state(input_list_of_transactions, input_transaction_state, return_list_of_transactions):
    assert filter_by_state(input_list_of_transactions, input_transaction_state) == return_list_of_transactions